...
7. **Assumptions** panel — Glass Box / privacy note; not clinical advice; static-preview banner on Pages.
...
## Done when
- New tab usable end-to-end; build passes; README updated; PR or push to repo.
